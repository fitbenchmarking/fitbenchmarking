...
autodoc_mock_imports = ['mantid', 'ral_nlls', 'pycutest', 'dfols',
                        ...
                        'theseus', 'torch', 'lmfit', 'nlopt', 'codecarbon',
                        'paramonte']
...
htmlhelp_basename = 'FitBenchmarkingdoc'
...
latex_documents = [
    (master_doc, 'FitBenchmarking.tex', 'FitBenchmarking Documentation',
     'STFC', 'manual'),
]
...
man_pages = [
    (master_doc, 'fitbenchmarking', 'FitBenchmarking Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'FitBenchmarking', 'FitBenchmarking Documentation',
     author, 'FitBenchmarking', 'One line description of project.',
     'Miscellaneous'),
]
