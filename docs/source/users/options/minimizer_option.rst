...
.. warning::
   MATLAB must be installed for this to be available; See :ref:`installing-external-software`.
...
.. warning::
   MATLAB Optimization Toolbox must be installed for this to be available; See :ref:`installing-external-software`.
