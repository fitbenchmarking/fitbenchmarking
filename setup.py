...
setup(name='FitBenchmarking',
      ...
      package_data={'': ['examples',
                         'fitbenchmarking/fonts/FiraSans/*/*',
                         'fitbenchmarking/fonts/FontAwesome/*',
                         'fitbenchmarking/templates/*',
                         'fitbenchmarking/templates/css/*',
                         'fitbenchmarking/templates/js/*',
                         'fitbenchmarking/templates/js/output/chtml/fonts/woff-v2/*',
                         ],
                   }
)
