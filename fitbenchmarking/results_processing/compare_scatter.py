...
class CompareScatterView:
    ...
    def __init__(self):
        """
        Initialise the compare_scatter_view class.
        """
...
class compare_scatter_data_model:
    ...
    def get_hover_text_array(self):
        # return an array of hover text in the same sorted order as the results
        # for example x: [1,2,3]
        # matches array: ["hover1","hover2","hover3"]
        pass

    def get_unique_problems(self):
        # return an array of problems in the same sorted order as the results
        # this means that they can be used for grouping
        # for example x: [1,2,3,4,5,6]
        # matches array: ["p123","p123","p123","p456","p456","p456"]
        # where "p123" is a group containing the first second and third points
        pass
