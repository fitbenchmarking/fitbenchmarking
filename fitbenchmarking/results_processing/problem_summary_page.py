...
def create(best_results, group_name, support_pages_dir, options):
    """
    ...
    """
    for grouped_best_results in best_results:
        _create_best_page(grouped_best_results, group_name, support_pages_dir, options)


def _create_best_page(best_results, group_name, support_pages_dir, options):
    """
    ...
    # description
    # initial_guess
    # initial_plot_available
    # initial_plot
    # equation
    # best_results
    # best_plots_available
    # best_plots
