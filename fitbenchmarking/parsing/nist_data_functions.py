"""
Functions that prepare the function specified in NIST problem definition
file into the right format for SciPy.
"""
...
def nist_func_definitions(function, startvals):
    ...
    for values in all_values:
        exec "def fitting_function(x, " + (
            param_names) + "): return " + function_scipy_format
