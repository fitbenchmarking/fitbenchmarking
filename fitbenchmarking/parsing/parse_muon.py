...
def load_file(fname):
    """
    Loads a muon file with all the necessary data.

    @param fname :: path to the muon problem definition file
    ...
    with open(fname) as probf:
        entries = get_muon_data_problem_entries(probf)
...
def get_data_file(fname, input_file):
    """
    Gets the path to the muon data_file used in the problem.
    ...
    to ../muon_data and adds ../muon_data/data_files

    @param fname :: path to the muon problem definition file
    @param input_file :: name of the muon data file
...
def get_muon_data_problem_entries(fname):
    """
    Get the problem entries from a muon problem definition file.
