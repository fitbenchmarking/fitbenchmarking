...
that support problems with parameter bounds
"""
...
class ScipyBoundsController(Controller):
    """
    ...
    def __init__(self, cost_func):
        ...
        """
        super(ScipyBoundsController, self).__init__(cost_func)
        ...
        self.algorithm_check = {
            'all': ['Powell', 'L-BFGS-B', 'TNC', 'SLSQP'],
            'ls': [None],
            'deriv_free': ['Powell'],
            'general': ['Powell', 'L-BFGS-B', 'TNC', 'SLSQP']}
    ...
    def fit(self):
        ...
        """
        # The Powell minimizer does not require a Jacobian
        # so is run without that argument.
        if self.minimizer == "Powell":
