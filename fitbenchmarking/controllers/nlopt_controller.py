...
class NLoptController(Controller):
    ...
    algorithm_check = {
        ...
        "general": ["LD_SLSQP", "LD_VAR2", "LD_VAR1", "AUGLAG", "AUGLAG_EQ"],
        "simplex": ["LN_NELDERMEAD", "LN_SBPLX"],
        "trust_region": ["LN_COBYLA", "LD_CCSAQ", "LD_MMA"],
        "levenberg-marquardt": [],
        "gauss_newton": [
            "LD_TNEWTON_PRECOND_RESTART",
            "LD_TNEWTON_PRECOND",
    ...
    def cleanup(self):
        ...
        converged = [nlopt.SUCCESS, nlopt.XTOL_REACHED, nlopt.FTOL_REACHED]
