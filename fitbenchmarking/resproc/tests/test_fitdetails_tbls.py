...
from resporc.fitdetails_tbls import parse_nist_function_def
from resporc.fitdetails_tbls import parse_neutron_function_def
from resporc.fitdetails_tbls import fit_details_table_hdims
